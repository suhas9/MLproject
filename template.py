...
for filepath in list_of_files:
    ...
    """ how exist_ok works : if "directory" already exist,os.makedirs()will not raise an error,
     and it will do nothing. If "my_directory" does not exist it will create it """
